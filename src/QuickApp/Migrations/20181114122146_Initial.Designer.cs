...
namespace QuickApp.Migrations
{
    ...
    [Migration("20181114122146_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Installment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("InstallmentHistoryId")
                        .IsRequired();
                    ...
                    b.HasIndex("InstallmentHistoryId");

                    b.ToTable("Installments");
                });

            modelBuilder.Entity("DAL.Models.InstallmentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("InstallmentHistories");
                });
            ...
            modelBuilder.Entity("DAL.Models.Installment", b =>
                {
                    b.HasOne("DAL.Models.InstallmentHistory", "InstallmentHistory")
                        .WithMany("Installments")
                        .HasForeignKey("InstallmentHistoryId")
